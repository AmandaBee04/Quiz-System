...
if(!empty($_POST))
{
    ...
    else
    {
        ...
        window.location.href='soalan-set.php';
        </script>";
    }
}
?>
...
<select class="w3-select w3-border w3-round-large" name='jenis'>
       ...
       <td><input class="w3-input w3-border w3-round-large" type='text' name='masa' value='<?PHP echo $_GET['masa']; ?>'></td>
       <td><input class='w3-button w3-block w3-black w3-round-large' type='submit' value='Kemaskini'></td>
</form>
    </tr>
<?PHP
...
# malaksanakan arahan untuk memilih data
...
<a href='padam.php?jadual=set_soalan&medan=no_set&kp=".$data['no_set']."'onClick=\"return confirm('Anda pasti anda ingin memadam data ini.')\" title='Padam' > <i class=' w3-xxlarge fa fa-trash' aria-hidden='true'></i></a>
